                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-heder with-border">
                                <center>
                                    <h2 class="box-title">Add Addmission<h2>
                                </center>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="add_admissioncheck" class="create-account-form" method="POST"
                                enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="box-body">
                                        <div class="col-sm-9">
                                            <label>Headline</label>
                                            <input type="text" name="admission_headline" class="form-control"
                                                required="required" placeholder="">
                                        </div>

                                        <div class="col-sm-9">
                                            <label for="exampleInputPassword1">Sub headline</label>
                                            <input type="text" name="admission_subheadline" class="form-control"
                                                required="required" placeholder="">
                                        </div>

                                        <div class="col-sm-9">
                                            <label for="exampleInputPassword1">Link</label>
                                            <input type="text" name="admission_bottom" class="form-control"
                                                required="required" placeholder="">
                                        </div>
