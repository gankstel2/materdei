                    ...
                    <div class="box-body">
                        <div class="box box-primary">
                            <div class="box-heder with-border">
                                <center>
                                    <h2 class="box-title">Add About<h2>
                                </center>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="add_aboutcheck" class="create-account-form" method="POST"
                                    ...
                                    <div class="box-body">
                                        <div class="box-body">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="a_bottom" class="form-control"
                                                    required="required" placeholder="">
                                            </div>

                                            <div class="col-sm-10">
                                                <label>Details</label>
                                                <textarea type="text" id="editor" name="a_details"
                                                    class="form-control"></textarea>
                                            </div>

                                            <div class="col-sm-6">
                                                <label for="exampleInputFile">Add image</label>
                                                <input type="file" name="a_img" required="required">
