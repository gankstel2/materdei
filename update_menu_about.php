                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="about_headline" class="form-control" required="required"
                                    value="<?php echo $row['about_headline'];?>" placeholder="">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <!-- <div class="col-sm-3"><img id="imgShow" src="images/<?php // echo $row['about_banner'];?>"width="100px"> </div> -->
                            ...
                            <div class="col-sm-6">
                                <br><label for="exampleInputFile">Edit image mobile</label>
                                <br><img src="images/<?php echo $row['about_mobanner'];?>" width="150px"><br>
                                <!-- <div class="col-sm-3"><img id="imgShow" src="images/<?php // echo $row['about_mobanner'];?>"width="100px"> </div> -->
                                <!-- <input type="file" name="admission_moimg"> -->
                                <p> This is a old picture</p>
                                <input type="hidden" name="oldfile" value="<?= $row['about_mobanner']; ?>">
                                <input id="imgEdit" type="file" name="about_mobanner2" value="">
                                <p class="help-block">Choose file</p>
                            </div>
                        </div>
                    </div>
