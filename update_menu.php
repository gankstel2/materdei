            ...
            <div class="box box-primary">
                ...
                <center>
                    ...
                    <?php
                     ...
                     if($id!='')	{
                        $sql = "SELECT * FROM tb_menu where menu_id='".$id."'";
                    ...
                    <form action="update_menucheck" class="create-account-form" method="POST"
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" name="menu_headline" class="form-control" required="required"
                                    placeholder="" value="<?php echo $row['menu_headline'];?>">
                                <div class="box-footer">
                                    <button type="submit" id="submitcreate" class="btn btn-primary">Edit</button>
                                </div>
                            </div>
                        </div>
                    </form>
