                    ...
                    <div class="box-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-heder with-border">
                                <center>
                                    <h2 class="box-title">Add Serviam<h2>
                                </center>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="add_serviamcheck" class="create-account-form" method="POST"
                                enctype="multipart/form-data">
                                <div class="box-body">
                                    <div class="box-body">
                                        <div class="col-sm-9">
                                            <label>Headline</label>
                                            <input type="text" name="serviam_headline" class="form-control"
                                                required="required" placeholder="">
                                        </div>

                                        <div class="col-sm-9">
                                            <label for="exampleInputPassword1">Sub headline</label>
                                            <input type="text" name="serviam_subheadline" class="form-control"
                                                required="required" placeholder="">
                                        </div>

                                        <div class="col-sm-6">
                                            <label for="exampleInputFile">Add image</label>
                                            <input type="file" name="serviam_img">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="file" name="serviam_moimg">
